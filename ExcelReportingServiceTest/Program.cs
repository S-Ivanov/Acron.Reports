using ExcelReportingServiceTest.ExcelService;
using System;
...
namespace ExcelReportingServiceTest
{
    class Program
    {
        static void Main(string[] args)
        {
            using (ExcelReportingServiceClient client = new ExcelReportingServiceClient())
            {
                var excelStream = client.GetExcelReport(SourceData,
